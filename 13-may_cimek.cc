...
int main () {
  ...
  //3
  vector<string>::iterator legkisebb = min_element(db.begin(), db.end(), kisebb); //FONTOS: UJ FUGGVENY: min_element
  ...
  //6 *FONTOS:* sokat tanultam ebben a feladatban
  int index = 0;
  ...
  //7 //FONTS: GECISOKAT TANULTAM ITT IS
  while(1) {
    bool changesInThisStep = false;
    modositott = buff;
